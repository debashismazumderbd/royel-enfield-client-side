                        ...
                        <div className="dk-footer-box-info">
                            <Link to="/" onClick={scrollHandler} className="footer-logo">
                                <div className="d-flex justify-content-center">
                                    <img src={Logo} alt="footer_logo" height="20" />
                                </div>
                                <h3 className="mb-0 text-center text-white">Royel Enfield</h3>
                            </Link>
                            ...
                            <Col md={12} lg={6}>
                                <div className="footer-widget footer-left-widget">
                                    <div className="section-heading">
                                        <h3>Useful Links</h3>
                                        <span className="border-black animate-border"></span>
                                    </div>
                                    <ul>
                                        <li>
                ...
                <Container>
                    <Row>
                        <Col md={6} className="order-2 order-md-1">
                            <span>Copyright © {new Date().getFullYear()}, All Rights Reserved Royel Enfield</span>
                        </Col>
