...
const OrderList = () => {
    ...
    useEffect(() => {
        axios.get(`https://calm-scrubland-90649.herokuapp.com/orders?email=${email}`)
            .then(res => {
                setOrders(res.data);
                setLoading(false);
            })
    ...
    const handleStatusChange = (id, status) => {
        ...
        axios.patch('https://calm-scrubland-90649.herokuapp.com/updateOrderStatus', modifiedStatus)
